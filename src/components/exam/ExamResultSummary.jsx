...
import { Eye, RefreshCw, LogOut, X } from "lucide-react" // Thêm các icon mới
            ...
            >
                <div className="bg-purple-900 w-full max-w-xl rounded-xl p-6 shadow-lg text-center space-y-6">
                                ...
                                <div className="space-y-1 text-sm">
                                    {data.rankResponse.rankings.map((r, i) => {
                                        ...
                                        return (
                                            <div
                                                key={i}
                                                className={`flex justify-between items-center px-3 py-1 rounded ${isCurrentUser
                    ...
                    <div className="flex flex-col gap-2 mt-6">
                        ...
                        >
                            <Eye size={18} /> {/* Thay FileText bằng Eye để nhấn mạnh xem chi tiết */}
                            Xem chi tiết
                        </Button>
                        ...
                        {!isOnline && (
                            ...
                            >
                                <RefreshCw size={18} /> {/* Thay RotateCcw bằng RefreshCw để rõ ràng hơn */}
                                Chơi lại
                            </Button>
                        )}
                        ...
                        <Button
                            ...
                            onClick={() => router.push("/users/dashboard")}
                        >
                            <LogOut size={18} /> {/* Thay Search bằng LogOut để phù hợp với "Thoát" */}
                            Thoát
                        </Button>
                    </div>
                </div>
