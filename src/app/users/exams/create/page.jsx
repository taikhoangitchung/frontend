                        ...
                        <Card className="p-0 shadow-lg border-gray-300 bg-white">
                            ...
                            <CardContent className="p-6 space-y-5 bg-white">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-gray-700 font-medium h-6 flex items-center">Số lượng câu hỏi</Label>
                                        <Select
                                ...
                                <div className="flex flex-col md:flex-row gap-4 w-full">
                                    ...
                                    <div className="space-y-2 w-full md:w-auto flex-shrink-0">
                                        ...
                                        <Select value={questionSource} onValueChange={setQuestionSource}>
                                            <SelectTrigger className="border-gray-300 bg-gray-50 focus:border-purple-500 h-9">
