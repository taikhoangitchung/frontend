...
export default function LandingPage() {
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-blue-gray-50 via-purple-gray-50 to-pink-gray-50 relative overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-20 left-10 w-32 h-32 bg-blue-200 rounded-3xl rotate-12 opacity-60"></div>
                <div
                    className="absolute top-40 right-20 w-24 h-20 bg-purple-200 rounded-2xl -rotate-12 opacity-60"></div>
                <div
            ...
            <main className="relative z-10 px-6 py-16">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-gray-700 text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
                        Thiết kế và triển khai tài liệu giảng dạy toàn diện, giúp mọi học sinh chinh phục mục tiêu học
                        tập.
                    </p>
                </div>
            </main>
